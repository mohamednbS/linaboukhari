...
<<<<<<< HEAD
                                ...
                                <div class="alert alert-success alert-dismissible" role="alert">
										...
										<i class="fa fa-check-circle"></i> Sous-équipement modifié avec succès <span  class="btn btn-sm btn-default"> Routouner à la page précédente pour voir les modifications </span>
								</div>
                                @endif
