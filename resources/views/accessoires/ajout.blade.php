					...
					<div class="panel panel-headline">
						...
						<div class="col-md-12">
							...
							<div class="panel">
                                ...
                                <form action="{{ route('Accessoires.store', ['equipement_id_equipement' => $equipement]) }}" class="MultipleRecord" method="POST" enctype="multipart/form-data">
                                            ...
                                            {{ csrf_field() }}  
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-9">
                                                                <input style="width:100%;margin-bottom:10px;" class="form-control" placeholder="Tapper le code de l'équipement içi" type="text" name="identifiant" id="validationDefault01" required>
                                                                ...
                                                                <div class="col-md-9">
                                                                     <input style="width:100%;margin-bottom:10px;" class="form-control" placeholder="Tapper la modele de l'équipement içi" type="text" name="designation" id="validationDefault02" required>
                                                                </div>
